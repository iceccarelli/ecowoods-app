/**
 * GET /glossary/{slug}.md  (rewritten from this path by next.config.js)
 *
...
import { termMarkdown } from '@/lib/markdown-export';

export const dynamic = 'force-static';

export function generateStaticParams() {
  return getTerms().map((x) => ({ slug: x.slug }));
}
