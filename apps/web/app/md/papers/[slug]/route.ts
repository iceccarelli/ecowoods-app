/**
 * GET /papers/{slug}.md  (rewritten from this path by next.config.js)
 *
...
import { paperMarkdown } from '@/lib/markdown-export';

export const dynamic = 'force-static';

export function generateStaticParams() {
  return getPapers().map((x) => ({ slug: x.slug }));
}
