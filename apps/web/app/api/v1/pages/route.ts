/**
 * GET /api/v1/pages — see lib/registry/handlers.ts and /api/v1/openapi.json.
 ...
 */
import { handlePages } from '@/lib/registry/handlers';
import { options } from '@/lib/registry/http';

export const dynamic = 'force-dynamic';

export const GET = (request: Request) => handlePages(request);
