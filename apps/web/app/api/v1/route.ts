/**
 * GET /api/v1 — see lib/registry/handlers.ts and /api/v1/openapi.json.
 ...
 */
import { handleIndex } from '@/lib/registry/handlers';
import { options } from '@/lib/registry/http';

export const dynamic = 'force-dynamic';

export const GET = (request: Request) => handleIndex(request);
