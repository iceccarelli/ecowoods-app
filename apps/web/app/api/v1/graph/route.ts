/**
 * GET /api/v1/graph — see lib/registry/handlers.ts and /api/v1/openapi.json.
 ...
 */
import { handleGraph } from '@/lib/registry/handlers';
import { options } from '@/lib/registry/http';

export const dynamic = 'force-dynamic';

export const GET = (request: Request) => handleGraph(request);
